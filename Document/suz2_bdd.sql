...
CREATE TABLE IF NOT EXISTS `acheter` (
  ...
  PRIMARY KEY (`idAchat`),
  constraint id_assurance FOREIGN KEY (idAssurance) REFERENCES assurance (idAssurance),
  constraint id_assure FOREIGN KEY (idAssure) REFERENCES assure (idAssure),
  constraint id_type FOREIGN KEY (idType) REFERENCES typeassurance (idType)
...
CREATE TABLE IF NOT EXISTS `agent` (
  ...
  PRIMARY KEY (`idAgent`),
  constraint id_service FOREIGN KEY (idService) REFERENCES service (idService),
  constraint id_conge FOREIGN KEY (idConge) REFERENCES conge (idConge),
  constraint id_paie FOREIGN KEY (idPaie) REFERENCES paie (idPaie),
  constraint id_presence FOREIGN KEY (idPresence) REFERENCES presence (idPresence)
...
CREATE TABLE IF NOT EXISTS `declaration` (
 ...
 constraint id_assure FOREIGN KEY (idAssure) REFERENCES assure (idAssure),
 constraint id_accident FOREIGN KEY (idAccident) REFERENCES accident (idAccident)
...
INSERT INTO `presence` (`idPresence`, `annee`, `Janvier`, `Fevrier`, `Mars`, `Avril`, `Mai`, `Juin`, `Juillet`, `Aout`, `Septembre`, `Octobre`, `Novembre`, `Decembre`) VALUES
('Pr01', '2017', 22, 18, 23, 18, 25, 21, 21, 22, 21, 18, 22, 16),
('Pr02', '2017', 22, 20, 12, 20, 19, 21, 21, 17, 19, 21, 20, 16),
('Pr03', '2017', 22, 20, 21, 20, 23, 21, 21, 20, 21, 20, 19, 16),
('Pr04', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 22, 22, 16),
('Pr05', '2017', 20, 18, 19, 20, 23, 19, 19, 18, 21, 22, 22, 16),
('Pr06', '2017', 20, 18, 20, 20, 21, 20, 21, 18, 20, 22, 22, 16),
('Pr07', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 22, 22, 16),
('Pr08', '2017', 19, 14, 15, 17, 10, 20, 10, 12, 10, 18, 14, 12),
('Pr09', '2017', 20, 19, 20, 22, 23, 19, 12, 15, 20, 22, 22, 16),
('Pr10', '2017', 19, 20, 22, 19, 17, 19, 19, 20, 17, 20, 18, 16),
('Pr11', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 22, 22, 16),
('Pr12', '2017', 21, 19, 20, 19, 14, 15, 16, 17, 14, 16, 15, 15),
('Pr13', '2017', 12, 15, 14, 18, 20, 18, 20, 24, 15, 23, 20, 16),
('Pr14', '2017', 22, 19, 22, 22, 23, 21, 21, 20, 20, 22, 22, 16),
('Pr15', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 22, 22, 16),
('Pr16', '2017', 12, 12, 13, 12, 22, 15, 15, 18, 17, 20, 21, 12),
('Pr17', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 22, 22, 16),
('Pr18', '2017', 2, 16, 19, 17, 22, 19, 21, 20, 19, 19, 27, 14),
('Pr19', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 22, 22, 16),
('Pr20', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 20, 22, 16),
('Pr21', '2017', 19, 15, 23, 22, 23, 21, 21, 22, 21, 19, 22, 16),
('Pr22', '2017', 22, 20, 23, 22, 23, 21, 21, 22, 21, 23, 22, 16);
